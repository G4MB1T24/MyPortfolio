  ...
  return (
    <>
          <section class="text-gray-400 bg-gray-900 body-font">
              ...
              <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src={rat} />
          ...
          <div class="text-center lg:w-2/3 w-full">
              ...
              <Typewriter
                onInit={(Typewriter) => {
                  Typewriter.changeDelay(50)
                    ...
                    .pauseFor(1000)
                    .deleteAll()
                    .typeString("I'm a Passionate Coder.")
                    .pauseFor(1000)
                    .deleteAll()
            ...
            <p class="leading-relaxed mb-8 my-2 py-2">
              <button class="my-3 inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
                <Link to="aboutme" spy={true} smooth={true} duration={500} target="_blank" rel="noreferrer">
                  Read more.
                </Link>
              </button>
            </p>
